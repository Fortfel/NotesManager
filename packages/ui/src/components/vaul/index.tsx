...
// @see also fork on https://github.com/arrow2nd/vaul
// @ts-nocheck
'use client';
  ...
  React.useEffect(() => {
    function onVisualViewportChange() {
      ...
      if (isInput(focusedElement) || keyboardIsOpen.current) {
        ...
        // @Fortfel
        // if (isAndroid()) {
        //   diffFromInitial = diffFromInitial > 0 ? diffFromInitial + 50 : diffFromInitial;
        // }
        console.log('keybord height', diffFromInitial)
